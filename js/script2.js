...
var swiper = new Swiper(".work-slide", {
  ...
  $('.tabAll').click(function () {
    $('.work-tab li').removeClass('active'); 
      $('.work-content li.w2023').removeClass('bottom');
      $('.work-content li.w2022.last').removeClass('bottom'); 
      $('.work-content li.w2021.last').removeClass('bottom'); 
      $('.work-content li.w2020.last').removeClass('bottom'); 
      
    $(this).addClass('active');
    $('.work-content li').show();
  ...
  $('.tab2023').click(function () {
    $('.work-tab li').removeClass('active');  
      ...
      $('.work-content li.w2020.last').removeClass('bottom'); 
    $(this).addClass('active');
    $('.work-content li').hide();
      $('.work-content li.w2023').show();
      $('.work-content li.w2023').addClass('bottom'); 
  ...
  $('.tab2022').click(function () {
    ...
    $(this).addClass('active');
    $('.work-content li').hide();
      $('.work-content li.w2022').show();
      $('.work-content li.w2022.last').addClass('bottom'); 
  ...
  $('.tab2021').click(function () {
    ...
    $('.work-content li').hide();
    $('.work-content li.w2021').show();
     $('.work-content li.w2021.last').addClass('bottom'); 
  });  
    ...
    $('.work-content li').hide();
    $('.work-content li.w2020').show();
     $('.work-content li.w2020.last').addClass('bottom'); 
  });  
//스크롤 텍스트
